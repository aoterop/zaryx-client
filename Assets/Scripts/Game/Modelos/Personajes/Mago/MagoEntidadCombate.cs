...
{
    public class MagoEntidadCombate : IEntidadCombate
    {
        #region Propiedades
        ...
        public MagoEntidadCombate(byte idSesion, string nombre, int hp, int mp, short mapa, short x, short y, byte nivel, long exp)
        {
            IdSesion = idSesion;
            Nombre = nombre;
            Hp = hp;
